...
%
\author{Hirokazu Chiba\inst{1} \and Shota Matsumoto\inst{2} \and Ryota Yamanaka\inst{3}}
%
...
This data format is independent from graph database implementation. It is useful when we generate property graph data intermediately from other data sources in data integration pipelines. We also implemented a prototype of conversion tools to show that the data in this data format can be exchanged for various graph databases.
